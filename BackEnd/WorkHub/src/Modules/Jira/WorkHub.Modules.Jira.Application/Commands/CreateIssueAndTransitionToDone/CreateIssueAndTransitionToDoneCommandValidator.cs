...
public class CreateIssueAndTransitionToDoneCommandValidator
    : AbstractValidator<CreateIssueAndTransitionToDoneCommand>
{
    public CreateIssueAndTransitionToDoneCommandValidator()
    {
